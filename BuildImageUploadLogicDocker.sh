...
docker build -f Dockerfile -t aksh2002/image-upload-logic:tagversion .
# Now image building is done 
# So now we will push that image to dockerhub
echo "Pushing image-upload-logic"
docker push aksh2002/image-upload-logic:tagversion
...
# docker run -d -p 3000:3000 aksh2002/image-upload-logic &
